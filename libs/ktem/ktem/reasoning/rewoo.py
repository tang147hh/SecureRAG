...
class RewooAgentPipeline(BaseReasoning):
    ...
    def get_user_settings(cls) -> dict:
        ...
        return {
            "planner_llm": {
                "name": "Planner 使用的 language model",
                "value": llm,
                "component": "dropdown",
                "choices": llm_choices,
                "special_type": "llm",
                "info": (
                    "用于 planning 的 language model。"
                    "该 model 会基于 instruction 生成寻找答案的计划。"
                ),
            },
            "solver_llm": {
                "name": "Solver 使用的 language model",
                "value": llm,
                "component": "dropdown",
                "choices": llm_choices,
                "special_type": "llm",
                "info": (
                    "用于 solving 的 language model。"
                    "该 model 会基于 planner 生成的计划和 Tools 找到的依据生成答案。"
                ),
            },
            "highlight_citation": {
                "name": "高亮 Citation",
